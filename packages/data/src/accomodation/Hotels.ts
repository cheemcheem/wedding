import { HotelListItemProps } from '@wedding/components';

// prettier-ignore
export const hotels: HotelListItemProps[] = [
  ...
  { name:"No.1 - St Mary's Place",                      url:"https://no1apartments.co.uk/st-andrews/st-marys-place" },
  { name:"No.1 - South Street",                         url:"https://no1apartments.co.uk/st-andrews/south-street" },
